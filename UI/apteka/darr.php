...
if (!$conn) {
    ...
    //You must asign before.
        ...
        $stid = oci_parse($conn, "SELECT * FROM KAYRIMDILIK WHERE lower(NAME_K) like  lower('%$p1%' )");
        ...
        $stid = oci_parse($conn, "SELECT * FROM KAYRIMDILIK ");
        //Send parameters variable  value  lenght
    ...
    <div class="all" id="app">
        ...
        <a class="name_he" href="../test.php.html">
            ...
            <div class="name_he_title">
                ...
                <a href="apteka.php" style="color:black"> 
                     Аптеки
                </a>
                <a  href="lekarstva.php" style="color:black">
                   Лекарства
                </a>
                <a>
                     Мед. центры
        ...
        <?php   
          if($_POST['name']!=""){
            ...
            <?php
              ...
              this.posts.push({first: '<?php   print_r( $rowz['NAME_K'])  ?>',
                    last:'<?php    print_r( $rowz['SROK_K']); ?>', 
                suffix:'<?php   print_r( $rowz['NUMBER_YOUR']); ?>' });
