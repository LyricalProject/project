...
$sql = "begin 
dob09.salu(:zbai1 ,:zbai2,:zbai3,:zbai4,:zbai5);
end;";
...
oci_bind_by_name($stmt_id, ':zbai2', $san,32);

oci_bind_by_name($stmt_id, ':zbai3', $start,32);

oci_bind_by_name($stmt_id, ':zbai4', $end,32);

oci_bind_by_name($stmt_id, ':zbai5', $user,32);
            ...
            <div class="osn2">
                <div class="fir">
                    ...
                    <div class="ggg"> 
                       ...
                       <div class="call3">
                        <input type="text" name="san" class="q2z">
