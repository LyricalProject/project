...
error_reporting(E_ERROR | E_PARSE);
        ...
        $stid = oci_parse($conn, 'begin :cursor := APTEKI22; end;');
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                           ...
                           for ($x = 0; $x <(count ($cursorz)) ; $x+=1) {
                               
                 ?>
                  <tr>
                    <td><?php  echo (( $cursorz[$x]['NAME1'])) ?></td>
                    <td><?php  echo ( $cursorz[$x]['SURNAME'] ) ?></td>

                    <td><?php  echo ( $cursorz[$x]['CITY'] ) ?></td>
                    <td><?php  echo ( $cursorz[$x]['MOBILE'] ) ?></td>
                    <td><?php  echo ( $cursorz[$x]['EMAILL'] ) ?></td>
